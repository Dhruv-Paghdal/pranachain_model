...
# &nbsp;  https://github.com/Dhruv-Paghdal/pranachain\_model.git
...
# 3\. \*\*Sample test files\*\* are available in the `test\_file/` folder for demonstration purposes.
...
# ├── test\_file/            # Sample .txt files for demonstration

# │   ├── test\_diabetes\_data.txt

# │   ├── test\_heart\_data.txt

# │   └── test\_kidney\_data.txt
